const firebaseConfig = {
  apiKey: "AIzaSyDcDkSV1z5Ob599yDlf57lEzjlHkFdLOI8",
  authDomain: "ig-ch-2c751.firebaseapp.com",
  projectId: "ig-ch-2c751",
  storageBucket: "ig-ch-2c751.firebasestorage.app",
  messagingSenderId: "889714512864",
  appId: "1:889714512864:web:59fb1d7b542dd67a469185"
};
...
window.toggleTheme = function() {
    ...
    localStorage.setItem('igchem-theme', isDark ? 'light' : 'dark');
};
// Apply saved theme on load
(function() {
    const saved = localStorage.getItem('igchem-theme');
    if(saved === 'dark') {
...
try {
    ...
    function createCard(gridId, data, docId) {
        ...
        let iconHtml = (gridId === 'gameGrid') ? '<i class="fa-solid fa-puzzle-piece"></i>' : '<i class="fa-solid fa-flask"></i>';
    ...
    window.openFolderPage = async function(folderId, folderName) {
        ...
        history.pushState({ igchem: 'folder' }, '');
...
window.openFileInViewer = function(filePath) {
    ...
    history.pushState({ igchem: 'viewer' }, '');
};
